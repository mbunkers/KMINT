...
void C2DMatrix::TransformVector2Ds(std::vector<SVector2D> &vPoint){
...
//applies a 2D transformation matrix to a single SVector2D
void C2DMatrix::TransformVector2Ds(SVector2D &vPoint){
...
void C2DMatrix::Rotate(const SVector2D &fwd, const SVector2D &side){
	C2DMatrix::Matrix mat;
