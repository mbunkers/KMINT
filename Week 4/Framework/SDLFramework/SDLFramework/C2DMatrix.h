#ifndef __C2DMATRIX_H__
#define __C2DMATRIX_H__
//------------------------------------------------------------------------
//
//  Name:   C2DMatrix.h
//
...
public:
	...
	inline void  Rotate(const SVector2D &fwd, const SVector2D &side);

	//applys a transformation matrix to a vector of points
	inline void TransformVector2Ds(vector<SVector2D> &vPoints);

	//applys a transformation matrix to a point
	inline void TransformVector2Ds(SVector2D &vPoint);
...
inline void C2DMatrix::TransformVector2Ds(vector<SVector2D> &vPoint)
{
...
inline void C2DMatrix::TransformVector2Ds(SVector2D &vPoint)
{
...
inline void C2DMatrix::Rotate(const SVector2D &fwd, const SVector2D &side)
{
	C2DMatrix::Matrix mat;
